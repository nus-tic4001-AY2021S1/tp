 ...
 * is missing in the seedu.tracker.command. <p>
 * Catch that seedu.tracker.exception somewhere else and print the message inside the seedu.tracker.exception object.
 */
