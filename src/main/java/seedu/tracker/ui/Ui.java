...
public class Ui {
    ...
    public void printHelp() {
        String help = "What you can tell me to do is listed below:\n"
            ...
            + " - Create a new project        | " + colorGreen("--project --name INPUT --description INPUT --involve INPUT --startdate dd/mm/yyyy --duedate dd/mm/yyyy --incharge INPUT\n")
    ...
    public void printProjectCreated(ProjectList projects) {
        String added = "Great! You have created a proper project as shown below:\n"
            + colorGreen(projects.get(projects.size() - 1).getDescription()
