...
public class StartDate extends Command {
    public static final String word = "--startdate";

    public StartDate(String line, ProjectList projects, Ui ui, Storage storage) {
